...
const OtherAssignConsent = ({ classes, otherAssignConsentFields, onInputChange }) => {
  return (
      ...
      <div className={cx('other-assign-consent-form-container')}>
        <FormControlLabel
          ...
          control={
            <Checkbox
              ...
              checked={otherAssignConsentFields.ngo === true}
              onChange={onInputChange('otherAssignConsent.ngo')}
            />
          }
        ...
        <FormControlLabel
          ...
          control={
            <Checkbox
              classes={{root: classes.checkBoxRoot, checked:classes.checked}}
              checked={otherAssignConsentFields.medical === true}
              onChange={onInputChange('otherAssignConsent.medical')}
            />
          }
