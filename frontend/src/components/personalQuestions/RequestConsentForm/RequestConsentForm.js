        ...
        <ExpansionPanel classes={{root: classes.expansionPanelRoot, expanded: classes.expansionPanelExpanded}}>
          ...
          <ExpansionPanelDetails >
            <Typography classes={{root: classes.expanded}}>
              <br/>
              <p className={cx('expand-panel-text-center')}>비영리민간의료단체 프리메드는(이하 프리메드) 신입 단원 선발을 위해 참고할 개인 정보를 수집하고 있습니다.</p><br/><br/>
              <strong>1. 수집하는 개인정보 항목</strong><br/>
              - 이름, 주소, 전화번호, 이메일 주소, 휴대폰 번호를 비롯하여 ‘비영리민간의료단체 프리메드 제 19기 신입 단원 공개 선발 지원 서식’ 에 포함된 모든 정보<br/><br/>
              <strong>2. 개인정보 수집 방법</strong><br/>
              ...
              <strong>3. 개인정보 수집 및 이용 목적</strong><br/>
              ...
              <strong>5. 개인 정보 제 3자 제공 안내</strong><br/>
              - 프리메드는 수집된 정보를 제 3자에게 제공하지 않습니다.<br/>
              <br/>
              동의를 거부할 수 있으며, 동의 거부 시 프리메드 제 19기 신입 단원 공개 선발 과정에서 일부 불이익이 있을 수 있습니다.<br/>
              <br/><strong className={cx('expand-panel-text-center')}>「개인정보보호법」 등 관련 법규에 의거하여 상기 본인은 위와 같이 개인정보 수집 및 활용에 동의합니다.</strong><br/>
            </Typography>
          </ExpansionPanelDetails>
        </ExpansionPanel>
      </div>
